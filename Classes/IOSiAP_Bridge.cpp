...
void IOSiAP_Bridge:: requestProducts(int id)
{
    ...
    product.push_back("consumable001_lineupfree");
    product.push_back("consumable002_lineupfree");
    product.push_back("consumable005_lineupfree");
    product.push_back("consumable0010_lineupfree");
    product.push_back("consumable0050_lineupfree");
...
void IOSiAP_Bridge::onRequestProductsFinish(void)
{
    ...
    switch (productID) {
        case 1:
            identifier = "consumable001_lineupfree";
            break;
        case 2:
            identifier = "consumable002_lineupfree";
            break;
        case 3:
            identifier = "consumable005_lineupfree";
            break;
        case 4:
            identifier = "consumable0010_lineupfree";
            break;
        case 5:
            identifier = "consumable0050_lineupfree";
            break;
        default:
            break;
    }
