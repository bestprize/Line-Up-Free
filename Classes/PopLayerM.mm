...
void PopM::setContentMLink(){
    ...
    linkItem->setPosition(visibleSize.width*2/5,visibleSize.height/3 + 100);
    ...
    linkItem1 = MenuItemImage::create(
                                     "qi-adv-120.png",
                                     "qi-adv-180.png",
                                     CC_CALLBACK_1(PopM::menulinkToOther1, this));
    
    linkItem1->setPosition(visibleSize.width*3/5,visibleSize.height/3 + 100);
...
void PopM::menulinkToOther1(Ref* pSender)
{
